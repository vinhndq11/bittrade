...
$config['licenseName'] = getenv('CKFINDER_DOMAIN','act.net');
$config['licenseKey']  = getenv('CKFINDER_KEY','Y7372W5CCK3EYDY2YVHQLPWTH89CS');
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => '/upload/',
    'root'         => dirname(dirname(__DIR__)) . DIRECTORY_SEPARATOR . 'upload', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
